...
//Do arquivo filmes.js retorne no terminal o Titulo, Ano e Genero
...
for(let i=0; i < obj.length; i++){
    ...
    // console.log({"titulo": filme.Title, "ano": filme.Year, "genero": filme.Genre})

    // console.info(filme.Title, filme.Year, filme.Genre) 

    //(desafio: apresente cada Genero em linhas separadas)
    stringGenero = filme.Genre
    // console.log(stringGenero)
